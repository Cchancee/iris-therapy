...
export default function TherapistsPage() {
  ...
  // Filter rows based on name or phone_number
  const filteredRows = therapists.filter(
    (therapist) =>
      ...
      therapist.phone_number?.toLowerCase().includes(searchQuery.toLowerCase())
  );
    ...
    <div>
      ...
      >
        ...
        <Typography variant="body1" sx={{ mb: 2 }}>
          View and manage the list of patients.
        </Typography>
        <TextField
          variant="outlined"
          size="small"
        ...
        >
          ...
          {selectedTherapist && (
            <Box sx={{ mt: 2 }}>
              ...
              <Typography>
                <strong>Phone Number:</strong> {selectedTherapist.phone_number}
              </Typography>
              <Typography>
